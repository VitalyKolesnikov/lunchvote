...
public class UserTestData {
    ...
    public static final User USER4 = new User(USER4_ID, "User4", "user4@gmail.com", "{noop}pass4", Role.USER);
    public static final User USER5 = new User(USER5_ID, "User5", "user5@gmail.com", "{noop}pass5", Role.USER);
    public static final User USER6 = new User(USER6_ID, "User6", "user6@gmail.com", "{noop}pass6", Role.USER);
